...
<html>
    ...
    <body>
        <h3 class="text-center">Entrada de Producto (sumar)</h3>
        <!-- En tu archivo.jsp -->
                    ...
                    <tbody>
                        <c:forEach items="${productos}" var="p">
                            <tr>
                                ...
                                <td>${p.estatus}</td>
                                <td>
                                    <form action="Controlador?menu=entrada&rol=${rol}&accion=sumar&idP=${p.idProducto}&oriC=${p.cantidad}" method="POST">
                                        <div class="d-inline-flex justify-content-evenly align-items-start">
                                            ...
                                            <input type="submit" name="accion" value="Sumar" class="btn btn-info px-1 mx-1">
                                        </div>
                                    </form>
                                </td>
                            </tr>
